        ...
        <><div className="text-opacity-90">
            ...
            <div className="w-[80%] m-auto ">
                <div className="flex flex-col items-center justify-center min-h-[90vh] ">
                    <h1 className="text-8xl font-bold counter ">We are building </h1>
                    <h1 className="text-8xl my-6 font-bold">you a home</h1>
                    <p className="text-3xl counter">in the world of crypto</p>
                </div>
                ...
                <div className="h-screen w-[80%] flex flex-col justify-center m-auto">
                    <h1 className="text-center text-6xl font-bold counter">Backed by the best</h1>
